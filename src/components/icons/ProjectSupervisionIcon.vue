                            ...
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                    ...
                                    <g transform="translate(2.000000, 2.000000)">
                                        <path fill-rule="evenodd" fill="#85A4E6"
                                        ...
                                        <path fill-rule="evenodd" fill="#5C85DE"
                                        ...
                                        <rect x="10" y="6.2" fill-rule="evenodd" fill="#85A4E6" width="10.5" height="2.2">
                                        </rect>
                                        <rect x="10" y="8.5" fill-rule="evenodd" fill="#5C85DE" width="10.5" height="0.8">
                                        </rect>
                                        <rect x="10" y="6.2" fill-rule="evenodd" fill="#3367D6" width="0.8" height="2.2">
                                        </rect>
                                        <rect x="10" y="8.5" fill-rule="evenodd" fill="#3367D6" width="0.8" height="12">
                                        </rect>
                                    </g>
                                </g>
                            </g>
