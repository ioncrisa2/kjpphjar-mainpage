    ...
    <header class="sticky top-0 z-50 bg-black/10 transition duration-300">
        <div class="container">
            <div class="flex items-center justify-between py-5 lg:py-0">
                <router-link to="/"><img src="/assets/images/h-logo.png" alt="logo" class="h-10" /></router-link>
                <div class="flex items-center">
                    <div @click="toggleMenu()" class="overlay fixed inset-0 z-[51] bg-black/60 lg:hidden"
                    ...
                    <div class="menus" :class="{ 'overflow-y-auto ltr:!right-0 rtl:!left-0': showMenu }">
                        <div class="border-b border-gray/10 ltr:text-right rtl:text-left lg:hidden">
                            <button @click="toggleMenu()" type="button" class="p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" class="h-6 w-6 text-black dark:text-white">
                        ...
                        <ul @click="showMenu = false">
                            ...
                            <li>
                                <router-link to="/rekan-klien" :class="{active:$route.name === '/rekan-klien'}" >Rekan dan Klien</router-link>
                            </li>
                            <li>
                                <router-link to="/gallery" :class="{active:$route.name === '/gallery'}" >Galeri</router-link>
                            </li>
                            <li>
                                <router-link to="/contact-us" :class="{active:$route.name === '/contact-us'}">Contact Us</router-link>
                            </li>
                        ...
                        <li>
                            <button type="button"
                                ...
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" :class="{ hidden: store.theme === 'dark' }">
                                    <path
                                ...
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" :class="{ hidden: store.theme === 'light' }">
                                    <path
