<template>
    <div>
        <div
            class="bg-[url(/assets/images/consulting/banner-bg.jpg)] bg-cover bg-bottom bg-no-repeat pt-[82px] lg:pt-[106px]">
            <div class="relative">
                <div class="container">
                    ...
                    <div class="heading text-center ltr:lg:text-left rtl:lg:text-right">
                        ...
                        <ul class="mt-8 flex items-center justify-center gap-4 lg:justify-start" data-aos="fade-up" data-aos-duration="500">
                            <li class="h-[45px] w-[45px] md:h-[60px] md:w-[60px]">
                                <a href="https://www.instagram.com/kjpphenricusdanrekan/" target="_blank" class="group">
        ...
        <section class="lg:py-[100px]">
            <div class="container mt-10" v-for="item in Braches" :key="item.id">
                <div class="heading !mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                    <h4 class="sm:!leading-[50px]">{{ item.position }}</h4>
                </div>
                <div class="mb-5 grid gap-[30px] md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="rounded-[32px] bg-white px-4 py-6 dark:bg-gray-dark md:p-7" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h5 class="font-bold text-black dark:text-white lg:text-lg">{{ item.location }}</h5>
                    </div>
                </div>
                <!-- where map placed -->
                    <div class="flex flex-col sm:flex-row rounded-[32px] dark:drop-shadow-none" data-aos="fade-up" data-aos-duration="1000">
                            <div
                                class="mt-5 bg-white dark:bg-gray-dark md:grid md:grid-cols-2 lg:mt-0 sm:w-1/2 relative"
                                style="width:40vw;height:30vh;position:relative;z-index:0;"
                                :id="'map-'+item.id">
                            </div>
                            <div class="sm:w-1/2 flex flex-col justify-center py-10 px-5 sm:px-8">
                                <ul class="space-y-4">
                                    <li class="flex gap-3 rounded-[32px] bg-white px-10 py-10 dark:bg-gray-dark dark:text-white dark:hover:text-primary lg:text-l">
                                        <div class="pt-1">
                                        ...
                                        <div class="flex flex-col">
                                            <a :href="item.mapsUrl" target="_blank">
                                                <div class="text-xl font-extrabold sm:text-lg text-primary">Alamat</div>
                                                <div class="text-sm font-bold sm:text-lg">{{ item.address }}</div>
                                            </a>
                                        </div>
                                    </li>
                                </ul>
...
<script setup>
    ...
    const Braches = [
        {
            id:1,
            position:"Kantor Pusat",
            location:"Palembang, Sumatera Selatan",
            phone:"0711-5615793",
            email:"henricusja@yahoo.com",
            address:"Ruko Terminal Sako No. 18, Lebung Gajah, Palembang",
            latitute:-2.9309659153861505,
            longtitude:104.79062355342076,
            mapsUrl:"https://www.google.com/maps/place/2%C2%B055'51.5%22S+104%C2%B047'26.2%22E/@-2.9310068,104.7887215,17.33z/data=!4m4!3m3!8m2!3d-2.9309659!4d104.7906236?entry=ttu"
        },
        {
            id:2,
            position:"Cabang Surabaya",
            location:"Surabaya, Jawa Timur",
            phone:"0812-3121-8422",
            email:"kjpphjasurabaya@gmail.com",
            address:"Jln. Kebonsari LVK VII/51 RT 007 RW-003, Surabaya",
            latitute:-7.323643419477218,
            longtitude:112.71687287331551,
            mapsUrl:"https://www.google.com/maps/place/7%C2%B019'25.1%22S+112%C2%B043'00.7%22E/@-7.3236381,112.714298,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-7.3236434!4d112.7168729?entry=ttu"
        },
        {
            id:3,
            position:"Cabang Balikpapan",
            location:"Balikpapan, Kalimantan Timur",
            phone:"0853-9333-6515",
            email:"kjpphajarkaltim@gmail.com",
            address:"Jln. Penggalang No.19  RT. 033 Damai Balikpapan",
            latitute:-1.2621375219397608,
            longtitude:116.85719186501848,
            mapsUrl:"https://www.google.com/maps/place/1%C2%B015'43.7%22S+116%C2%B051'25.9%22E/@-1.2621321,116.854617,17z/data=!3m1!4b1!4m4!3m3!8m2!3d-1.2621375!4d116.8571919?entry=ttu"
        },
    ];

    const mapRefs = [ref(null),ref(null),ref(null)];

    onMounted(() => {
        Braches.forEach((mapRefs, index) => {
            const branch = Braches[index];

            mapRefs.value = L.map(`map-${index+1}`).setView([branch.latitute,branch.longtitude],14);
