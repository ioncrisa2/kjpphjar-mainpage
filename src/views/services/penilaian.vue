    ...
    <div>
                ...
                <div class="container">
                    <div class="items-center justify-between py-10 md:flex md:h-[400px] md:py-0">
                        <div class="heading relative mb-0 text-center ltr:md:text-left rtl:md:text-right">
                            <h6 class="!text-white">Jasa Layanan Penilaian</h6>
        ...
        <div>
            <div class="flex items-center flex-col px-4">
                <h2 class="text-4xl lg:text-5xl font-extrabold text-center leading-tight text-gray-800 md:w-9/12 pt-4">Penilaian Properti Sederhana</h2>
            </div>
            <div class="mt-20 flex flex-wrap justify-between px-4">
                <div class="flex sm:w-full md:w-5/12 pb-20">
                    <div class="w-20 h-20 relative mr-5">
                        ...
                        <div class="absolute text-black bottom-0 left-0 bg-indigo-700 rounded w-16 h-16 flex items-center justify-center mt-2 mr-3">
